...
import accessories from '@/app/assets/Ecommerce accesories.png'
import accessories01 from '@/app/assets/Ecommerce accesories (10).png'
import accessories02 from '@/app/assets/Ecommerce accesories (1).png'
import accessories03 from '@/app/assets/Ecommerce accesories (2).png'
import accessories04 from '@/app/assets/Ecommerce accesories (3).png'
import accessories05 from '@/app/assets/Ecommerce accesories (4).png'
import accessories06 from '@/app/assets/Ecommerce accesories (5).png'
import accessories07 from '@/app/assets/Ecommerce accesories (6).png'
import accessories08 from '@/app/assets/Ecommerce accesories (7).png'
import accessories09 from '@/app/assets/Ecommerce accesories (8).png'
import accessories10 from '@/app/assets/Ecommerce accesories (9).png'
